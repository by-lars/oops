...
public class Main {
	...
	public static void testAddStorableToVault() {
		...
		System.out.println("AddStorableToVault:");
		System.out.println(vault.addStoreableToVault(new Storeable(1)));
		System.out.println(vault.addStoreableToVault(new Storeable(0)) == false);
		System.out.println(vault.addStoreableToVault(null) == false);
		System.out.println("\n");
	}
